<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebInscripcionAgregar.aspx.cs" Inherits="WebInscripcionAgregar" %>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        <h5>
                            <asp:Label ID="lblInscripcionAgregar" runat="server" Text="Agregar Inscripcion" ></asp:Label>
                            <asp:Label ID="lblInscripcionEditar" runat="server" Text="Editar Inscripcion" Visible="False"></asp:Label>
                        </h5> 
                    </div>
